...
const OrderDetails = async ({ params }: { params: { orderId: string }}) => {
  ...
  return (
    <div className="flex flex-col p-10 gap-5">
      ...
      <p className="text-base-bold">
        Tổng tiền đã thanh toán: <span className="text-base-medium">${orderDetails.totalAmount}</span>
      </p>
      <p className="text-base-bold">
        Shipping ID: <span className="text-base-medium">{orderDetails.shippingRate}</span>
      </p>
